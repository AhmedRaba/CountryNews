...
import com.example.countrynews.databinding.FragmentGeneralBinding
...
class GeneralFragment : Fragment() {
    ...
    private fun showGeneralNews(countryName: String) {
        ...
        retrofit.getModifiedNews(countryName, "general").enqueue(object : Callback<News> {
